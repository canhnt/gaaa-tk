...
public class TestXMLEncryption {
    ...
    static org.apache.commons.logging.Log log = 
        org.apache.commons.logging.LogFactory.getLog(
            TestXMLEncryption.class.getName());
    ...
    public static Document encryptDocPublic (Document document, Key pubkek) throws Exception {
	    ...
	    System.out.print("\n###Public key encryption key (for symmetric key): \n" 
	    		+ pubkek.toString() + "\n");
    ...
    private static SecretKey GenerateAndStoreKeyEncryptionKey(String jceAlgorithmName, String kekfname)
        ...
        f.close();
        System.out.println(
            "Key encryption key stored in " + kekFile.toString());
    ...
    public static void main(String unused[]) throws Exception {
      	...
      	String inputFile = "aaareq02test.xml";
       	...
       	try {   	
       		...
       		switch(s) {
       			...
       			case 2: {
       				...
       				return;}
       			case 3: { 
       		    	inputFile = "encrypted3-test01.xml";
       				Document docext = readFileToDOM (inputFile); 
       		    	...
       		    	//
       				inputFile = "saml20assertion-authn01.xml";
       				Document docext2 = readFileToDOM (inputFile); 
       				Key kek2 = GenerateAndStoreKeyEncryptionKey(jceAlgoKey, "kek2");
       				Document docencr2 = encryptDocPublic (document, pubkek);
       				HelpersXMLsecurity.printDOMdoc(docencr);
       				HelpersXMLsecurity.saveDOMdoc(docencr2, inputFile);
       				//printDOMdoc(docencr);
       				return;}
       			case 4: {
       				String filename = "enc4public-doc.xml";
       				Document docencr = encryptDocPublic (document, pubkek);
       				outputDocToFile(docencr, "enc4public-doc.xml"); 
       				HelpersXMLsecurity.printDOMdoc(docencr);
       				HelpersXMLsecurity.saveDOMdoc(docencr, filename);
       				//printDOMdoc(docencr);
       				return;}
