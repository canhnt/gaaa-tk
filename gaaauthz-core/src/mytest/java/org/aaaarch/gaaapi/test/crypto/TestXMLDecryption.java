 ...
 * @author $Author: demch $
*/
public class TestXMLDecryption {

    /** {@link org.apache.commons.logging} logging facility */
    static org.apache.commons.logging.Log log = 
        org.apache.commons.logging.LogFactory.getLog(
            TestXMLDecryption.class.getName());
	...
	throws Exception {
        ...
        String kekfname = ConfigSecurity.LOCAL_DIR_SYMKEYSTORE + "kek";
    ...
    public static void main(String unused[]) throws Exception {
        ...
        String kekdir = ConfigSecurity.LOCAL_DIR_SYMKEYSTORE;
       	...
       	try {   	
       		...
       		switch(s) {
       			...
       			case 2: { 
       				...
       				return;}
       			case 3: {
       		    	String encryptedXML = "encrypted3-test01.xml";
					Document doc3encext = loadEncryptionDocument(encryptedXML );
